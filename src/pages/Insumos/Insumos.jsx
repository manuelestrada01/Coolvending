                ...
                return (
                  ...
                  >
                    ...
                    <div className="ins-card-body">
                      ...
                      {item.descripcion && <p className="ins-card-desc">{item.descripcion}</p>}
                      <div className="ins-card-footer">
                        {price && <p className="ins-card-price">{price}</p>}
                        {item.cantidad && <span className="ins-card-qty">{item.cantidad}</span>}
                      </div>
                    </div>
                  </div>
                );
