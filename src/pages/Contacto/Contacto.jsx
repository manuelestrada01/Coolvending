            ...
            <Col lg={4}>
              <div ref={sidebarRef} className={`ctc-sidebar ctc-reveal ctc-reveal--left${sidebarVisible ? " ctc-reveal--visible" : ""}`}>
                ...
                <div className="ctc-contacts">
                  <a href="tel:+5492615661521" className="ctc-contact-card ctc-card-reveal" style={{ animationDelay: sidebarVisible ? "0.1s" : "0s" }}>
                    ...
                    <div>
                      ...
                      <p className="ctc-contact-value">+54 9 261 566-1521</p>
                    </div>
                  ...
                  <div className="ctc-contact-card ctc-card-reveal" style={{ animationDelay: sidebarVisible ? "0.46s" : "0s" }}>
                    ...
                    <div>
                      ...
                      <p className="ctc-contact-value">Lunes a Viernes · 9 a 18 hs</p>
                    </div>
                  </div>
                </div>

                <div className="ctc-socials">
                  <a href="https://wa.me/5492615661521" target="_blank" rel="noopener noreferrer" className="ctc-social ctc-social--wa">
                  ...
                  <a href="https://instagram.com/coolvending.ar?igsh=azN0OTI5dDFpOHM2" target="_blank" rel="noopener noreferrer" className="ctc-social ctc-social--ig">
                    <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
