            ...
            <Col lg={4}>
              <div ref={sidebarRef} className={`ctc-sidebar ctc-reveal ctc-reveal--left${sidebarVisible ? " ctc-reveal--visible" : ""}`}>
                ...
                <div className="ctc-contacts">
                  <a href="tel:+5492612318259" className="ctc-contact-card ctc-card-reveal" style={{ animationDelay: sidebarVisible ? "0.1s" : "0s" }}>
                    ...
                    <div>
                      ...
                      <p className="ctc-contact-value">+54 9 2612 31-8259</p>
                    </div>
                ...
                <div className="ctc-socials">
                  <a href="https://wa.me/5492612318259" target="_blank" rel="noopener noreferrer" className="ctc-social ctc-social--wa">
